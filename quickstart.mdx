...
<Tabs>
  ...
  <Tab title="LangChain">
    ...
    ```bash poetry
    poetry add arzule-ingest[langchain]
    ```

    ```bash uv
    uv add arzule-ingest[langchain]
    ```
    </CodeGroup>
  </Tab>
  <Tab title="AutoGen">
    ...
    ```bash poetry
    poetry add arzule-ingest[autogen]
    ```

    ```bash uv
    uv add arzule-ingest[autogen]
    ```
    </CodeGroup>
  </Tab>
</Tabs>
...
<Note>
For core SDK without framework extras: `pip install arzule-ingest`
</Note>
